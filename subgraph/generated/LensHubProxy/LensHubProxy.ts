...
export class LensHubProxy__getProfileResultValue0Struct extends ethereum.Tuple {
  get pubCount(): BigInt {
...
export class LensHubProxy__getPubResultValue0Struct extends ethereum.Tuple {
...
export class LensHubProxy__getPubPointerResult {
  value0: BigInt;
  value1: BigInt;
...
export class LensHubProxy__tokenDataOfResultValue0Struct extends ethereum.Tuple {
  get owner(): Address {
...
export class LensHubProxy extends ethereum.SmartContract {
  static bind(address: Address): LensHubProxy {
    return new LensHubProxy("LensHubProxy", address);
  }
  ...
  getProfile(profileId: BigInt): LensHubProxy__getProfileResultValue0Struct {
    let result = super.call(
      "getProfile",
    ...
    return result[0].toTuple() as LensHubProxy__getProfileResultValue0Struct;
  }

  try_getProfile(
    profileId: BigInt
  ): ethereum.CallResult<LensHubProxy__getProfileResultValue0Struct> {
    let result = super.tryCall(
      "getProfile",
      "getProfile(uint256):((uint256,address,address,string,string,string))",
      [ethereum.Value.fromUnsignedBigInt(profileId)]
    ...
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as LensHubProxy__getProfileResultValue0Struct
    );
  }
  ...
  getPub(
    profileId: BigInt,
    pubId: BigInt
  ): LensHubProxy__getPubResultValue0Struct {
    let result = super.call(
      "getPub",
    ...
    return result[0].toTuple() as LensHubProxy__getPubResultValue0Struct;
  }

  try_getPub(
    profileId: BigInt,
    pubId: BigInt
  ): ethereum.CallResult<LensHubProxy__getPubResultValue0Struct> {
    let result = super.tryCall(
      "getPub",
      "getPub(uint256,uint256):((uint256,uint256,string,address,address,address))",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as LensHubProxy__getPubResultValue0Struct
    );
  }
  ...
  getPubPointer(
    profileId: BigInt,
    pubId: BigInt
  ): LensHubProxy__getPubPointerResult {
    let result = super.call(
      "getPubPointer",
    ...
    return new LensHubProxy__getPubPointerResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getPubPointer(
    profileId: BigInt,
    pubId: BigInt
  ): ethereum.CallResult<LensHubProxy__getPubPointerResult> {
    let result = super.tryCall(
      "getPubPointer",
      "getPubPointer(uint256,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new LensHubProxy__getPubPointerResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  tokenDataOf(tokenId: BigInt): LensHubProxy__tokenDataOfResultValue0Struct {
    let result = super.call(
      "tokenDataOf",
    ...
    return result[0].toTuple() as LensHubProxy__tokenDataOfResultValue0Struct;
  }

  try_tokenDataOf(
    tokenId: BigInt
  ): ethereum.CallResult<LensHubProxy__tokenDataOfResultValue0Struct> {
    let result = super.tryCall(
      "tokenDataOf",
      "tokenDataOf(uint256):((address,uint96))",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as LensHubProxy__tokenDataOfResultValue0Struct
    );
  }
...
export class BurnWithSigCall__Inputs {
  ...
  get sig(): BurnWithSigCallSigStruct {
    return this._call.inputValues[1].value.toTuple() as BurnWithSigCallSigStruct;
  }
}
...
export class CollectWithSigCall__Inputs {
  ...
  get vars(): CollectWithSigCallVarsStruct {
    return this._call.inputValues[0].value.toTuple() as CollectWithSigCallVarsStruct;
  }
}
...
export class CollectWithSigCallVarsStruct extends ethereum.Tuple {
  ...
  get sig(): CollectWithSigCallVarsSigStruct {
    return this[4].toTuple() as CollectWithSigCallVarsSigStruct;
  }
}
...
export class CommentCall__Inputs {
  ...
  get vars(): CommentCallVarsStruct {
    return this._call.inputValues[0].value.toTuple() as CommentCallVarsStruct;
  }
}
...
export class CommentWithSigCall__Inputs {
  ...
  get vars(): CommentWithSigCallVarsStruct {
    return this._call.inputValues[0].value.toTuple() as CommentWithSigCallVarsStruct;
  }
}
...
export class CommentWithSigCallVarsStruct extends ethereum.Tuple {
  ...
  get sig(): CommentWithSigCallVarsSigStruct {
    return this[8].toTuple() as CommentWithSigCallVarsSigStruct;
  }
}
...
export class CreateProfileCall__Inputs {
  ...
  get vars(): CreateProfileCallVarsStruct {
    return this._call.inputValues[0].value.toTuple() as CreateProfileCallVarsStruct;
  }
}
...
export class FollowWithSigCall__Inputs {
  ...
  get vars(): FollowWithSigCallVarsStruct {
    return this._call.inputValues[0].value.toTuple() as FollowWithSigCallVarsStruct;
  }
}
...
export class FollowWithSigCallVarsStruct extends ethereum.Tuple {
  ...
  get sig(): FollowWithSigCallVarsSigStruct {
    return this[3].toTuple() as FollowWithSigCallVarsSigStruct;
  }
}
...
export class MirrorCall__Inputs {
  ...
  get vars(): MirrorCallVarsStruct {
    return this._call.inputValues[0].value.toTuple() as MirrorCallVarsStruct;
  }
}
...
export class MirrorWithSigCall__Inputs {
  ...
  get vars(): MirrorWithSigCallVarsStruct {
    return this._call.inputValues[0].value.toTuple() as MirrorWithSigCallVarsStruct;
  }
}
...
export class MirrorWithSigCallVarsStruct extends ethereum.Tuple {
  ...
  get sig(): MirrorWithSigCallVarsSigStruct {
    return this[5].toTuple() as MirrorWithSigCallVarsSigStruct;
  }
}
...
export class PermitForAllCall__Inputs {
  ...
  get sig(): PermitForAllCallSigStruct {
    return this._call.inputValues[3].value.toTuple() as PermitForAllCallSigStruct;
  }
}
...
export class PostCall__Inputs {
  ...
  get vars(): PostCallVarsStruct {
    return this._call.inputValues[0].value.toTuple() as PostCallVarsStruct;
  }
}
...
export class PostWithSigCall__Inputs {
  ...
  get vars(): PostWithSigCallVarsStruct {
    return this._call.inputValues[0].value.toTuple() as PostWithSigCallVarsStruct;
  }
}
...
export class PostWithSigCallVarsStruct extends ethereum.Tuple {
  ...
  get sig(): PostWithSigCallVarsSigStruct {
    return this[6].toTuple() as PostWithSigCallVarsSigStruct;
  }
}
...
export class SetDefaultProfileWithSigCall__Inputs {
  ...
  get vars(): SetDefaultProfileWithSigCallVarsStruct {
    return this._call.inputValues[0].value.toTuple() as SetDefaultProfileWithSigCallVarsStruct;
  }
}
...
export class SetDefaultProfileWithSigCallVarsStruct extends ethereum.Tuple {
  ...
  get sig(): SetDefaultProfileWithSigCallVarsSigStruct {
    return this[2].toTuple() as SetDefaultProfileWithSigCallVarsSigStruct;
  }
}
...
export class SetDispatcherWithSigCall__Inputs {
  ...
  get vars(): SetDispatcherWithSigCallVarsStruct {
    return this._call.inputValues[0].value.toTuple() as SetDispatcherWithSigCallVarsStruct;
  }
}
...
export class SetDispatcherWithSigCallVarsStruct extends ethereum.Tuple {
  ...
  get sig(): SetDispatcherWithSigCallVarsSigStruct {
    return this[2].toTuple() as SetDispatcherWithSigCallVarsSigStruct;
  }
}
...
export class SetFollowModuleWithSigCall__Inputs {
  ...
  get vars(): SetFollowModuleWithSigCallVarsStruct {
    return this._call.inputValues[0].value.toTuple() as SetFollowModuleWithSigCallVarsStruct;
  }
}
...
export class SetFollowModuleWithSigCallVarsStruct extends ethereum.Tuple {
  ...
  get sig(): SetFollowModuleWithSigCallVarsSigStruct {
    return this[3].toTuple() as SetFollowModuleWithSigCallVarsSigStruct;
  }
}
...
export class SetFollowNFTURIWithSigCall__Inputs {
  ...
  get vars(): SetFollowNFTURIWithSigCallVarsStruct {
    return this._call.inputValues[0].value.toTuple() as SetFollowNFTURIWithSigCallVarsStruct;
  }
}
...
export class SetFollowNFTURIWithSigCallVarsStruct extends ethereum.Tuple {
  ...
  get sig(): SetFollowNFTURIWithSigCallVarsSigStruct {
    return this[2].toTuple() as SetFollowNFTURIWithSigCallVarsSigStruct;
  }
}
...
export class SetProfileImageURIWithSigCall__Inputs {
  ...
  get vars(): SetProfileImageURIWithSigCallVarsStruct {
    return this._call.inputValues[0].value.toTuple() as SetProfileImageURIWithSigCallVarsStruct;
  }
}
...
export class SetProfileImageURIWithSigCallVarsStruct extends ethereum.Tuple {
  ...
  get sig(): SetProfileImageURIWithSigCallVarsSigStruct {
    return this[2].toTuple() as SetProfileImageURIWithSigCallVarsSigStruct;
  }
}

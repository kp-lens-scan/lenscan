...
export class FollowNFT extends ethereum.SmartContract {
  ...
  tokenDataOf(tokenId: BigInt): FollowNFT__tokenDataOfResultValue0Struct {
    ...
    return result[0].toTuple() as FollowNFT__tokenDataOfResultValue0Struct;
  }
  ...
  try_tokenDataOf(
    ...
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as FollowNFT__tokenDataOfResultValue0Struct
    );
  }
...
export class DelegateBySigCall__Inputs {
  ...
  get sig(): DelegateBySigCallSigStruct {
    return this._call.inputValues[2].value.toTuple() as DelegateBySigCallSigStruct;
  }
}

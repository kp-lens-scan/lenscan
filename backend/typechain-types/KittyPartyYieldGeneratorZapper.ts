...
export interface KittyPartyYieldGeneratorZapperInterface
...
export type KittyPartyReadyToYieldEvent = TypedEvent<
  [string, BigNumber],
  { kittyparty: string; amountPerRound: BigNumber }
>;

export type KittyPartyReadyToYieldEventFilter =
  TypedEventFilter<KittyPartyReadyToYieldEvent>;
...
export interface KittyPartyYieldGeneratorZapper extends BaseContract {
  ...
  filters: {
    "KittyPartyReadyToYield(address,uint256)"(
      kittyparty?: null,
      amountPerRound?: null
    ): KittyPartyReadyToYieldEventFilter;
